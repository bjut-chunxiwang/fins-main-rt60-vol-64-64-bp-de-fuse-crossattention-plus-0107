...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.expand_vector_32d = nn.Linear(2, 512)  # Expands vector_32d from 32 to 64 dimensions
    ...
    def forward(self, x, vector_32d):
        ...
        vector_repeated = vector_32d_expanded.unsqueeze(2).repeat(1, 1, 16)  # 重复 16 次，变为 [1, 512, 16]
        ...
        z = torch.cat([attention_output_z_to_v, attention_output_v_to_z],dim=-1)  # 形状为 (batch_size, 1024)
